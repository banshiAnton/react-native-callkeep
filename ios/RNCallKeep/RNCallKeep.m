...
{
    [RNCallKeep reportNewIncomingCall: uuidString handle:handle handleType:handleType hasVideo:hasVideo localizedCallerName:localizedCallerName fromPushKit: NO afterShowComplete:^{
        NSLog(@"displayIncomingCall");
    }];
}
